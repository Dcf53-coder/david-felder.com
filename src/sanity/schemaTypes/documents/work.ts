...
export const work = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      group: "basic",
      description:
        "For unfinished pieces, these may be the expected completion date(s).",
    }),
    defineField({
    ...
    defineField({
      ...
      group: "basic",
      description:
        "Are there versions of this piece for an alternative instrumentation?",
      initialValue: false,
    }),
    defineField({
    ...
    defineField({
      ...
      group: "media",
      description:
        "Share one or more audio recordings. Paste SoundCloud URLs or other audio embed links.",
      of: [
        {
          type: "object",
          name: "audioEmbed",
          ...
          fields: [
            {
              ...
              type: "url",
              description:
                "Paste a SoundCloud URL (e.g., https://soundcloud.com/david-felder/track-name)",
              validation: (Rule) => Rule.required(),
            },
            {
              name: "title",
          ...
          fields: [
            {
              ...
              type: "url",
              description:
                "Paste a YouTube or Vimeo URL (e.g., https://www.youtube.com/watch?v=...)",
              validation: (Rule) => Rule.required(),
            },
            {
              name: "title",
    ...
    defineField({
      ...
      rows: 3,
      description:
        "By whom was the piece commissioned, for what purpose, etc.?",
    }),
    defineField({
      name: "dedication",
      title: "Dedication",
    ...
    defineField({
      ...
      group: "downloads",
      description:
        "Attach electronics files here to make them available for downloading",
      of: [{ type: "file" }],
    }),
    defineField({
